...
const Item = ({key, name, quantity, category}) => {
  return (
    <li key={key} className="w-96 h-16 border-solid border border-cyan-500 drop-shadow-lg rounded-md flex items-center mt-3">
